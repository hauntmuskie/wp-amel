...
import { Home, Database, BarChart3, Users, ClipboardList, TrendingUp, FileText, LogOut, Crown } from "lucide-react"
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-yellow-200 text-gray-900" : "text-gray-700 hover:bg-gray-100",
                  )}
                >
